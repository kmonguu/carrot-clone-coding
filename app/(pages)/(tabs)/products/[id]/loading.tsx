...
export default function Loading() {
  return (
    <div className="animate-pulse flex flex-col p-5 gap-5 ">
      <div className="flex justify-center items-center rounded-md border-neutral-700 border-4 aspect-square">
        <PhotoIcon className="h-28 text-neutral-700" />
      </div>
